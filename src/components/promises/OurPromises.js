      ...
      <div className="promises-container">
        <div className="maxWidth centerDiv">
          ...
          <Row type="flex" justify="space-around" align="top" className="margin-bottom-20 detailed-promises">
            <Col xs={24} sm={24} md={12} lg={12} className="blue-bg col-padding border-radius-5 detailed-promises-col">
            ...
            <Col xs={24} sm={24} md={12} lg={12} className="yellow-bg col-padding border-radius-5 detailed-promises-col">
